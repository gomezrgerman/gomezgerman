...
<head>
  ...
  <style>@import url('https://fonts.googleapis.com/css2?family=Anybody:wght@700;800&display=swap');</style>
</head>
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" bgcolor="${BG}" style="max-width:560px;width:100%;background-color:${BG} !important">
            ...
            <tr><td style="padding:6px" bgcolor="${BG}">
              <table width="100%" cellpadding="0" cellspacing="0" bgcolor="${BG_CARD}" style="border:1px solid ${BORDER};border-radius:2px;background-color:${BG_CARD} !important">
                <tr><td bgcolor="${BG_CARD}" style="padding:48px 44px 44px;text-align:center;background-color:${BG_CARD} !important">
                  <p style="margin:0 0 24px;font-size:10px;letter-spacing:0.2em;text-transform:uppercase;color:${GREEN};font-family:Georgia,serif">Germán Gómez</p>
                  <h1 style="margin:0 0 8px;font-size:64px;font-weight:800;letter-spacing:-0.04em;line-height:0.9;color:${CREAM};font-family:'Anybody',Georgia,serif">Recibido.</h1>
                  <p style="margin:0 0 32px;font-size:20px;font-weight:700;letter-spacing:-0.02em;color:${GREEN};font-family:'Anybody',Georgia,serif">Hola, ${escapeHtml(nombre)}.</p>
                  <div style="height:1px;background-color:${BORDER};margin:0 auto 32px;width:60px"></div>
                  <p style="margin:0 0 20px;font-size:15px;color:${CREAM};line-height:1.8;font-family:Georgia,serif;max-width:380px;margin-left:auto;margin-right:auto">Ya he leído lo que necesitas. Ahora toca la parte importante: ver si realmente merece la pena hacerlo y cómo hacerlo bien.</p>
                  <p style="margin:0 0 28px;font-size:15px;color:${CREAM};line-height:1.8;font-family:Georgia,serif;max-width:380px;margin-left:auto;margin-right:auto">En menos de 24 horas te responderé con algo útil para tu caso. No con una plantilla reciclada. Ni con una videollamada eterna para &#8220;entender tu negocio&#8221;.</p>
                  <a href="https://german-gomez.es/work" style="display:inline-block;font-size:12px;color:${GREEN};text-decoration:none;font-family:Georgia,serif;letter-spacing:0.08em;border-bottom:1px solid ${BORDER};padding-bottom:2px;margin-bottom:28px">Ver proyectos reales →</a>
                  <p style="margin:0;font-size:14px;color:${CREAM};line-height:1.8;font-family:Georgia,serif;max-width:380px;margin-left:auto;margin-right:auto">Si tienes prisa, responde a este correo. Aquí no responde un equipo de soporte. Respondo yo.</p>
                </td></tr>
              </table>
            </td></tr>
          </table>
        ...
        <tr><td bgcolor="${BG}" style="padding:36px 0 0;text-align:center;background-color:${BG} !important">
          <p style="margin:0 0 6px;font-size:13px;font-weight:700;letter-spacing:-0.01em;color:${CREAM};font-family:'Anybody',Georgia,serif">Germán Gómez</p>
          <p style="margin:0 0 12px;font-size:11px;color:${GREEN};letter-spacing:0.08em;text-transform:uppercase;font-family:Georgia,serif">Automatización &amp; Desarrollo Web</p>
          <a href="https://german-gomez.es" style="font-size:12px;color:${GREEN};text-decoration:none;font-family:Georgia,serif;letter-spacing:0.04em">german-gomez.es</a>
        </td></tr>
        <tr><td bgcolor="${BG}" style="padding:32px 0 0;text-align:center;border-top:1px solid ${BORDER};background-color:${BG} !important">
          <p style="margin:24px 0 0;font-size:10px;color:${GREEN};letter-spacing:0.06em;font-family:Georgia,serif">Has recibido este correo porque contactaste en german-gomez.es</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
