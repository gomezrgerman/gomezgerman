...
export default function HeroLogoReveal() {
  ...
  return (
    <motion.div
      ...
      style={{ width: 'clamp(260px, 34vw, 480px)', userSelect: 'none' }}
    >
      <div
        style={{
          ...
          borderRadius: 10,
          padding: 'clamp(1.25rem, 2.2vw, 1.875rem) clamp(1.5rem, 2.8vw, 2.25rem)',
      ...
      >
        <p
          ...
          style={{
            fontSize: 'clamp(1.15rem, 2.2vw, 2.2rem)',
            fontWeight: 600,
